...
class OrderFormPage(BasePage):
    ...
    def set_metro(self, station):
        ...
        container = self.find_element_with_wait(OrderFormLocators.METRO_STATION_LIST)
        first_option = container.find_element(*OrderFormLocators.SELECTED_STATION)
        first_option.click()
        return self
    ...
    def set_rental_duration(self):
        placeholder = self.find_element_with_wait(OrderFormLocators.RENTAL_DURATION_FIELD)
